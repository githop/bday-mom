...
function () {
  function App() {
    this.bdayMessages = ['Greg, Karen, and I love you! <span>♥</span>', 'Be as loud as you want when eating! <span>🍽</span>', 'You are a big impact on my life! <span>✨</span>', 'Mom (your wife) is Awesome! <span>💏</span>', 'Da Paw is loved by the grandkids! <span>👴</span>', 'Great golfer! (hole in one in the bag) <span>🏌</span>', 'You have great intiuition, personal and business <span>👁️‍🗨️</span>', 'Oldest Brother and pillar of an amazing family <span>🏛</span>', 'Great sense of humor! <span>🤣</span>', 'Will ask funny questions when filming you <span>🎬</span>', 'Loves speaking to strangers! <span>🙃</span>', 'Always around for us as kids <span>👪</span>', 'Fun to travel with! <span>🛫</span>'];
    this._bdMsgQueue = [];
  ...
  App.prototype._attachListeners = function () {
    ...
    this.cake.addEventListener('click', function (e) {
      return _this.onCakeClick(e);
    });
  };
